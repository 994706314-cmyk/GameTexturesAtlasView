...
# 流畅模式（默认关闭）
DEFAULT_SMOOTH_MODE = False
# 流畅模式动画时长 (ms) — 更短更丝滑
SMOOTH_ANIM_BOUNCE_IN = 300
SMOOTH_ANIM_ELASTIC_SNAP = 200
SMOOTH_ANIM_COLLISION = 200
SMOOTH_ANIM_AUTO_LAYOUT = 350
SMOOTH_ANIM_FADE_REMOVE = 150
SMOOTH_ANIM_HOVER = 80
SMOOTH_ANIM_BREATHING = 1500
# 流畅模式动画刷新间隔 (ms)  — 目标 60~120fps
SMOOTH_ANIM_UPDATE_INTERVAL = 8  # ~120fps
...
APP_VERSION = "1.8.4"  # 修复：清除 PyInstaller 6.x 正确的环境变量 _PYI_APPLICATION_HOME_DIR
